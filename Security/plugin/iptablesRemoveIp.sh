...
ipRuleIds=(`$ipTablesLocation -nL INPUT --line-numbers | grep $ip | grep DROP | awk '{ print $1 }'`)
...
ipRules=(`$ipTablesLocation -nL INPUT --line-numbers | grep $ip | grep DROP | awk '{ print $2 $3 $4 $5 $6 }'`)
